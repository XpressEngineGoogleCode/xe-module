<?php
    ...
    $lang->pointsend_content = '%s (%s) 님으로 부터 %s 포인트를 선물 받았습니다.<br /><br /><strong>※ 이 쪽지는 자동으로 발송된 쪽지입니다.</strong><br /><br />----------------------------<br />쪽지 내용 : <br />%s';
    $lang->pointsendc_title = '[알림] 포인트 선물이 관리자에 의해 취소되었습니다.';
    $lang->pointsendc_content = '%s (%s) 님으로 부터 받은 포인트 선물이 관리자에 의해 취소되어 %s 포인트가 차감되었습니다';
    $lang->pointsendc_content2 = '%s (%s) 님에게 보낸 포인트 선물이 관리자에 의해 취소되어 %s 포인트가 적립되었습니다';
